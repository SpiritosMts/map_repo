...
class _StationsMap extends State<StationsMap> {
  ...
  getMarkerData() async {
    FirebaseFirestore.instance.collection('garages').get().then((myMarkers) {
  ...
  void initMarker(specify , specifyId) async {
    ...
    final Marker marker = Marker(
      ...
      infoWindow: InfoWindow(title: 'garage_title' , snippet: specify['address']),
    );
    setState(() {
          ...
          children: <Widget>[
            Container(
                ...
                GoogleMap(
                  ...
                  initialCameraPosition: CameraPosition(target: LatLng(46.5412, -72.1452),zoom: 10.0,),
                  //initialCameraPosition: CameraPosition(target: LatLng(currentLocation.latitude, currentLocation.longitude),zoom: 10.0,),
